...
if (isset($_GET['id'])) {
    ...
    $thumbnail_result = mysqli_query($connectiion, $thumbnail_query);
    ...
    $delete_user_result = mysqli_query($connectiion, $delete_user_query);
    if (mysqli_errno($connectiion)) {
        $_SESSION['delete-user'] = "Coulden't delete '{$user['firstname']} '{$user['lastname']} '";
    } else {
